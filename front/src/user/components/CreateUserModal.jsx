...
export const CreateUserModal = ({ branches, onClose }) => {
  ...
  const modal = (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/50 backdrop-blur-sm">
      ...
      "
      >
        <ModalHeader title="تعریف کاربر جدید" onClose={onClose} />
        ...
        <div className="p-4 space-y-5" dir="rtl">
          ...
          <div>
            ...
            {usernameError && (
              <div className="mt-1 text-sm text-red-600 dark:text-red-400">{usernameError}</div>
            )}
          </div>
          ...
          <div>
            ...
            {phoneError && (
              <div className="mt-1 text-sm text-red-600 dark:text-red-400">{phoneError}</div>
            )}
          </div>
